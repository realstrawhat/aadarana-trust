      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-12 items-start">
        ...
        <div className="flex flex-col items-center md:items-end gap-4 md:gap-8 w-full mt-4 md:mt-8">
          <div className="flex gap-5 mt-4 md:mt-8">
            <a href="#" aria-label="Facebook" className="hover:text-[#1a8bd0] transition-colors text-2xl bg-white/10 rounded-full p-3">
              <SocialIcons.Facebook />
            </a>
            <a href="#" aria-label="Instagram" className="hover:text-[#1a8bd0] transition-colors text-2xl bg-white/10 rounded-full p-3">
              <SocialIcons.Instagram />
            </a>
            <a href="#" aria-label="X (Twitter)" className="hover:text-[#1a8bd0] transition-colors text-2xl bg-white/10 rounded-full p-3">
              <SocialIcons.X />
            </a>
            <a href="#" aria-label="LinkedIn" className="hover:text-[#1a8bd0] transition-colors text-2xl bg-white/10 rounded-full p-3">
